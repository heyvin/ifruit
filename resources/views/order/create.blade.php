    ...
    <main id="content" role="main">
        <article class="px3 py4">
            ...
            >
                ...
                <input type="text" name="name" class="col col-12 mb1">
                ...
                <div class="col col-12 center">
                    <input type="submit" class="ampstart-btn inline-block ampstart-fullpage-hero-cta h5 m3 text-decoration-none" value="Place Order">
                </div>
